...
const localeCopy = {
  ...
  en: {
    ...
    regionTitle: "Journey Start",
    regionText: "Sprigs will remember its weather.",
    locate: "Use Current Location",
    locateIdle: "You can also choose manually.",
    province: "Province",
    city: "City",
    birthdayTitle: "Wake Your Sprig",
    birthdayText: "Even while you were away, it kept waiting for you.",
    birthday: "Sprout Day",
    prev: "Back",
    next: "Next",
    submit: "Load Garden",
  ...
  ja: {
    ...
    province: "省",
    city: "市",
    birthdayTitle: "種々を起こす",
    birthdayText: "あなたがいない間も、ずっと待っていました。",
    birthday: "芽の日",
    prev: "戻る",
    next: "次へ",
    submit: "庭に入る",
  ...
  ko: {
    ...
    province: "지역 · 성/도",
    city: "도시",
    birthdayTitle: "쫑쫑 깨우기",
    birthdayText: "당신이 없는 동안에도 계속 기다리고 있었어요.",
    birthday: "생일",
    prev: "이전",
    next: "다음",
    submit: "정원 불러오기",
  ...
  es: {
    ...
    province: "Región",
    city: "Ciudad",
    birthdayTitle: "Despertar al sprig",
    birthdayText: "Mientras no estabas, siguió esperándote.",
    birthday: "Cumpleaños",
    prev: "Atrás",
    next: "Siguiente",
